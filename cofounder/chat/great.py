...
def run_daily_great_chat(session, message, user, channel_layer):
    ...
    alix = Alix(session.session_id, user.id, """Your client is feeling great today about their business.  They are feeling good and want to share their success with you.
