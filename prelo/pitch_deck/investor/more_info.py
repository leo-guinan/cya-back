...
from prelo.prompts.prompts import REJECTION_EMAIL_PROMPT, REQUEST_MORE_INFO_EMAIL_PROMPT
from submind.llms.submind import SubmindModelFactory
from submind.memory.memory import remember
from submind.models import Submind


def request_more_info(pitch_deck_analysis: PitchDeckAnalysis, investor: Investor, investor_submind: Submind):
    model = SubmindModelFactory.get_model(pitch_deck_analysis.deck.uuid, "request_more_info")
    prompt = ChatPromptTemplate.from_template(REQUEST_MORE_INFO_EMAIL_PROMPT)
