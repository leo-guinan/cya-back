...
from prelo.prompts.prompts import FOLLOWUP_EMAIL_PROMPT, MEETING_EMAIL_PROMPT
from submind.llms.submind import SubmindModelFactory
from submind.memory.memory import remember
from submind.models import Submind


def write_followup_email(pitch_deck_analysis: PitchDeckAnalysis, investor: Investor, investor_submind: Submind):
    model = SubmindModelFactory.get_model(pitch_deck_analysis.deck.uuid, "followup_email")
    prompt = ChatPromptTemplate.from_template(FOLLOWUP_EMAIL_PROMPT)
    chain = prompt | model.bind(function_call={"name": "followup_email"},
